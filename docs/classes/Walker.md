...
- `EventEmitter`
  ...
  ↳↳ [`ActionExecutor`](ActionExecutor.md)
...
▸ **add**(...`actions`): [`Walker`](Walker.md)<`T`\>
...
▸ **addAt**(`step`, ...`actions`): [`Walker`](Walker.md)<`T`\>
...
▸ **addListener**(`eventName`, `listener`): [`Walker`](Walker.md)<`T`\>
...
▸ **append**(...`actions`): [`Walker`](Walker.md)<`T`\>
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](Walker.md#defaultmaxlisteners).
...
▸ **off**(`eventName`, `listener`): [`Walker`](Walker.md)<`T`\>
...
▸ **on**(`eventName`, `listener`): [`Walker`](Walker.md)<`T`\>
...
▸ **once**(`eventName`, `listener`): [`Walker`](Walker.md)<`T`\>
...
▸ **prependListener**(`eventName`, `listener`): [`Walker`](Walker.md)<`T`\>
...
▸ **prependOnceListener**(`eventName`, `listener`): [`Walker`](Walker.md)<`T`\>
...
▸ **remove**(`count?`): [`Walker`](Walker.md)<`T`\>
...
▸ **removeAllListeners**(`event?`): [`Walker`](Walker.md)<`T`\>
...
▸ **removeAt**(`index`, `count?`): [`Walker`](Walker.md)<`T`\>
...
▸ **removeListener**(`eventName`, `listener`): [`Walker`](Walker.md)<`T`\>
...
▸ **setMaxListeners**(`n`): [`Walker`](Walker.md)<`T`\>
...
▸ **walk**(): `undefined` \| `T` \| `Promise`<`undefined` \| `T`\>
