            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, Reflect.apply(pageFun, ctx.page, ctx.json)];
                    case 4:
                        _a.sent();
                        _a.label = 5;
    ...
    ObjectExecutor.prototype.execute = function (ctx) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!ctx.json.use) return [3 /*break*/, 4];
                        _i = 0, _a = this.plugins;
                        _b.label = 1;
                    case 1:
                        if (!(_i < _a.length)) return [3 /*break*/, 4];
                        plugin = _a[_i];
                        if (!(plugin.name === ctx.json.use)) return [3 /*break*/, 3];
...
var DefaultExecutor = /** @class */ (function (_super) {
    ...
    DefaultExecutor.prototype.execute = function (ctx) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(typeof ctx.json !== "object")) return [3 /*break*/, 1];
                        return [3 /*break*/, 6];
                    case 1:
                        if (!Array.isArray(ctx.json)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.arrayExecutor.execute(ctx)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 3: return [4 /*yield*/, this.objectExecutor.execute(ctx)];
                    case 4:
    ...
    DefaultExecutor.prototype.executeAll = function (ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var _i, _a, action, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        console.log({
                    ...
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, this.execute(__assign(__assign({}, ctx), { json: action }))];
                    case 3:
                        _b.sent();
                        return [3 /*break*/, 5];
                    case 4:
