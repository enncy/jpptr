            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        fun = Reflect.get(this.page, key);
                        if (!(typeof fun === "function")) return [3 /*break*/, 2];
                        return [4 /*yield*/, Reflect.apply(fun, this.page, action)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
...
var ObjectExecutor = /** @class */ (function (_super) {
    ...
    function ObjectExecutor(page) {
        var _this = _super.call(this, page) || this;
        _this.page = page;
        _this.arrayExecutor = new ArrayExecutor(page);
        _this.plugins = plugins_1.default.map(function (plugin) { return new plugin(); });
        return _this;
    }
    ObjectExecutor.prototype.execute = function (action) {
        return __awaiter(this, void 0, void 0, function () {
            var _i, _a, plugin, name_1, invokeAction;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        plugin = _a[_i];
                        name_1 = Reflect.getMetadata("plugin:name", plugin.constructor);
                        if (!(name_1 === action.use)) return [3 /*break*/, 3];
                        return [4 /*yield*/, plugin.invoke(this.page, action)];
                    case 2:
...
var DefaultExecutor = /** @class */ (function (_super) {
    ...
    function DefaultExecutor(page) {
        var _this = _super.call(this, page) || this;
        _this.page = page;
        _this.arrayExecutor = new ArrayExecutor(page);
        _this.objectExecutor = new ObjectExecutor(page);
        return _this;
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        actions = _a.sent();
                        if (!actions) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.executeAll(actions)];
                    case 5:
                        _a.sent();
                        _a.label = 6;
    ...
    DefaultExecutor.prototype.executeAll = function (actions) {
        return __awaiter(this, void 0, void 0, function () {
