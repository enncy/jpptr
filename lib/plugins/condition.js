...
exports.default = {
    ...
    invoke: function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var actions, _i, _b, elseif, action;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!json.if) return [3 /*break*/, 2];
                        return [4 /*yield*/, handleIf({ page: page, frame: frame, json: json.if })];
                    case 1:
                        actions = _c.sent();
                        if (actions) {
                    ...
                    case 2:
                        ...
                        _i = 0, _b = json["else if"];
                        _c.label = 3;
                    case 3:
                        if (!(_i < _b.length)) return [3 /*break*/, 6];
                        elseif = _b[_i];
                        return [4 /*yield*/, handleIf({ page: page, frame: frame, json: elseif })];
                    case 4:
                        action = _c.sent();
                        if (action) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, handleCondition({ page: page, frame: frame, json: json }, _if.match, function (cdt, str) { return RegExp(cdt).test(str); })];
                case 1:
                    _b = (_c.sent());
                    _c.label = 2;
                case 2:
                    ...
                    // 处理字符串包含判断
                    else if (_if.include && handleCondition({ page: page, frame: frame, json: json }, _if.include, function (cdt, str) { return str.indexOf(cdt) !== -1; })) {
                        return [2 /*return*/, _if.actions];
                    }
                    return [2 /*return*/];
            }
 ...
 * @returns
 */
function handleCondition(_a, conditions, handler) {
    var page = _a.page, frame = _a.frame;
    return __awaiter(this, void 0, void 0, function () {
