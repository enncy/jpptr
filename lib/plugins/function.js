    ...
    run: function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        fun = Reflect.get(frame, action.name);
                        if (!fun) return [3 /*break*/, 3];
                        if (!(typeof fun === "function")) return [3 /*break*/, 2];
                        return [4 /*yield*/, Reflect.apply(fun, frame, action.args || [])];
                    case 1:
                        _b.sent();
                        _b.label = 2;
                    case 2: return [3 /*break*/, 6];
                    case 3:
                        pageFun = Reflect.get(page, action.name);
                        console.log(pageFun);
                        if (!pageFun) return [3 /*break*/, 6];
                        if (!(typeof pageFun === "function")) return [3 /*break*/, 5];
                        return [4 /*yield*/, Reflect.apply(pageFun, page, action.args || [])];
                    case 4:
                        _b.sent();
                        _b.label = 5;
